...
namespace _14.Point_and_Rectangle
{
    public partial class FormPointAndRectangle : Form
    {
        ...
        private void Draw()
        {
            ...
            /* Calculate the scale factor (ratio) for the diagram holding the rectangle and point in order to fit them well in the picture box */
            /* Калкулиране на мащаба(ratio) на диаграмата, съдържаща правоъгълника и точката, за да ги поберем в picture box-а */
            ...
            // Изчисляване на мащабираните кординати на правоъгълника
            ...
            // Изчисляване на мащабираните координати на точката
            ...
            // Изчертаване на правоъгълника и точката
            pictureBox.Image = new Bitmap(pictureBox.Width, pictureBox.Height);
            
            using (var g = Graphics.FromImage(pictureBox.Image))
            {
                // Draw diagram background (white area)
                // Изчертаване на бекграунда на чертежа (бялата зона)
                g.Clear(Color.White);

                // Draw the rectangle (scalled to the picture box size)
                // Изчертаване на правоъгълника (мащабиран според р-ра на кутията)
                var pen = new Pen(Color.Blue, 3);
                g.DrawRectangle(pen, rect);

                // Draw the point (scalled to the picture box size)
                // Изчертаване на точката (мащабирана според р-ра на кутията)
